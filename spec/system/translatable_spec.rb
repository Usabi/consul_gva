...
describe "Public area translatable records" do
  ...
  context "Globalize javascript interface" do
    scenario "Highlight current locale", :consul do
      visit new_debate_path

      expect_to_have_language_selected "English"
    end

    scenario "Highlight new locale added", :consul do
      visit new_proposal_path
    ...
    context "Languages in use" do
      ...
      scenario "Increase description count after add new language", :consul do
        visit new_proposal_path
  ...
  context "Existing records" do
    ...
    context "Update a translation", :consul do
      ...
      context "Update a translation with invalid data" do
        ...
        scenario "Show validation errors", :consul do
