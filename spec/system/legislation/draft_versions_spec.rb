...
describe "Legislation Draft Versions" do
  ...
  context "Annotations" do
    ...
    scenario "When page is restored from browser cache do not duplicate annotation handlers", consul: true do
    ...
    scenario "When page is restored from browser cache publish comment button keeps working", consul: true do
      Setting["org_name"] = "CONSUL"
      create(:legislation_annotation, draft_version: draft_version, text: "my annotation")
